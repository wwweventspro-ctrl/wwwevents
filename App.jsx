  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.wrap}>
        ...
        {complet && (
          <div style={styles.fullBanner}>Inscriptions closes — merci de votre intérêt !</div>
        )}
          ...
          <div style={styles.modalCard} onClick={(e) => e.stopPropagation()}>
            ...
            <div style={styles.modalBody}>
              ...
              <p style={styles.modalText}>
                96 équipes réparties en 32 poules de 3. Phase de poules suivie d'une élimination
                directe. 3v3, sur 3 terrains (6 paniers), matchs simultanés.
              </p>
              ...
              <p style={styles.modalText}>
                ...
                16 points. En cas d'égalité : panier en or (le premier panier marqué met fin au
                match). Changements illimités, à la volée. Pas de temps mort.
              </p>
              ...
              <p style={styles.modalText}>
                Inscription équipe (3 joueurs) : 60 €. Option 4e joueur (remplaçant) : +20 €.
                Aucun remboursement en cas de désistement d'une équipe, quel qu'en soit le motif.
              </p>
